...
CREATE TABLE IF NOT EXISTS "company_invoice_params" (
  ...
  "params" TEXT,
  "created_time" timestamp DEFAULT CURRENT_TIMESTAMP,
  "updated_time" timestamp DEFAULT CURRENT_TIMESTAMP, platform_name varchar(100),
...
CREATE TABLE IF NOT EXISTS "daily_report" (
  ...
  "upload_time" datetime, delivery_total decimal(10,2) Default 0,
...
CREATE TABLE IF NOT EXISTS "order_content_data" (
  ...
  "print_count" int,
  "del_flag" char(1) NOT NULL DEFAULT 'N',
  "del_time" datetime DEFAULT NULL, temp_bill_lock char(1) default 'N',
...
CREATE TABLE IF NOT EXISTS "order_data" (
  ...
  "created_time" timestamp DEFAULT CURRENT_TIMESTAMP,
  "updated_time" timestamp DEFAULT CURRENT_TIMESTAMP, delivery_fee decimal(10,2) default 0, import_source varchar(30),
...
(
   ...
   del_time             datetime,
   created_time         timestamp default CURRENT_TIMESTAMP,
   updated_time         timestamp, coin_discount decimal(10,2) default 0, points_discount decimal(10,2) default 0,
   primary key (order_no, item_no)
);
...
CREATE TABLE IF NOT EXISTS "terminal_data" (
  ...
  "last_daily_report_no" varchar(30), use_call_num_date char(8),
  PRIMARY KEY ("SID")
);
...
CREATE TABLE IF NOT EXISTS "user_data" (
  ...
  "created_time" timestamp DEFAULT CURRENT_TIMESTAMP,
  "updated_time" timestamp DEFAULT CURRENT_TIMESTAMP, sort integer default 0,
  PRIMARY KEY ("SID")
);
